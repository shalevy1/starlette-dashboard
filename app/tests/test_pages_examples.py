...
class Test(unittest.TestCase):
    def test_pages_examples(self):
        pages = ['403','404','500','blank','contacts','e_commerce','forgot-password',
        'invoice-print','invoice','lockscreen','login','pace','profile',
        'project_add','project_detail','project_edit','projects',
